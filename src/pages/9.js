...
export default () => (
	<div style={{paddingTop:'10px', paddingBottom:'20px', paddingLeft:'20%', paddingRight:'20%'}}>
		...
		<p style={{color:'gray'}}>April 30, 2020</p>
		
			<p>What do people love?</p>
			<p>Cats - cat videos, cat photos, petting cats</p>
			...
			<p>Art - paintings, sculpture, auctions, galleries</p>
			<p>Design - furniture, product design, 3d printing</p>
			...
			<p>Architecture - competitions, photography and video, drawings</p>
			<img style={{width:'200px'}} src='https://i.pinimg.com/originals/24/ed/72/24ed72535b9e2f62e436e6c0a8d0d2f9.gif'/>
			
			<p>Music - making music, playing guitar, learning music </p>
			<p>Film - making film, discussing film, critiquing film, watching film, discovering films </p>
